		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<form action="<?php echo base_url_admin().'general/update?state=logo' ?>" method="POST" enctype="multipart/form-data">
					...
					<?php } ?>
					<div class="col-lg-12 col-sm-12 col-xs-12"><center><span>File width x height maximum : 250px x 85px</span></center></div>
					<div class="row">
						<button type="submit" class="btn btn-primary pull-right fileUpload col-lg-3 col-md-5 col-sm-5 col-xs-5">Save</button>
						<div class="fileUpload btn btn-default pull-right col-lg-8 col-md-6 col-sm-6 col-xs-6">
